...
3.
  SELECT title, region FROM pilsētas;
4.
  SELECT * FROM pilsētas
  WHERE  year < 1924;
5.
  SELECT * FROM pilsētas
...
7.
  ...
  FROM pilsētas;
8.
  SELECT region FROM pilsētas
  GROUP By region;
9.
  DELETE FROM pilsētas WHERE title = 'Durbe';
  SELECT * FROM pilsētas;
10.
